...
namespace ChuongLibrary.GameDev
{
    public static class Game2D
    {
        ...
        {
            // Lấy kích thước của màn hình theo đơn vị thế giới
            ...
            // Tính tâm và bán kính của hình tròn
            var screenCenter = camera.transform.position;
            var screenRadius = Vector3.Distance(bottomLeft, topRight) / 2f;
            ...
            var randomPoint = screenCenter + new Vector3(randomDirection.x, randomDirection.y, 0) * randomDistance;
